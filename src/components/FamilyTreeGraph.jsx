...
const TreeBranch = ({ node, onSelect }) => {
  ...
  // card minWidth=120, connector=24, so center of couple = (120 + 24 + 120) / 2 = 132
  // center of just self = 120/2 = 60
  // shift needed = 132 - 60 = 72px
  const verticalLineOffset = hasSpouse ? '72px' : '-50%';
      ...
      <div style={{ display: 'flex', alignItems: 'center', position: 'relative' }}>
        ...
        {children.length > 0 && (
          <div style={{
            ...
            bottom: '-20px',
            left: '50%',
            transform: `translateX(${verticalLineOffset})`,
            width: '2px',
            height: '20px',
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          gap: '10px', color: '#475569', fontSize: '14px'
        }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <h3 style={{
            ...
            letterSpacing: '0.08em', color: '#94a3b8', marginBottom: '12px'
          }}>Assets</h3>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'inline-block', overflowX: 'auto' }}>
        {familyData ? (
          <TreeBranch node={familyData} onSelect={openMember} />
        ) : (
          <p>Loading...</p>
        )}
      </div>
